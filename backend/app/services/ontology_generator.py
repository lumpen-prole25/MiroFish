...
Interface: Analyze text content and generate entity/relationship type definitions for social simulation
"""
...
A. **Fallback types (required, placed at the end of the list)**:
   - `Person`: Fallback type for any individual. Use when a person doesn't fit other specific person types.
   - `Organization`: Fallback type for any organization. Use when an organization doesn't fit other specific types.
...
"""
    ...
    def generate_python_code(self, ontology: Dict[str, Any]) -> str:
        ...
        code_lines = [
            ...
            'Auto-generated by Geronimo for social opinion simulation',
            '"""',
            '',
