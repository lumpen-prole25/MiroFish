  ...
  >
    ...
    <div v-if="projects.length > 0" class="cards-container" :class="{ expanded: isExpanded }" :style="containerStyle">
      ...
      >
        ...
        <div class="card-header">
          ...
          <div class="card-status-icons">
            <span 
              ...
              title="{{ $t('history.tooltipGraphBuild') }}"
            >◇</span>
            <span 
              class="status-icon available" 
              title="{{ $t('history.tooltipEnvSetup') }}"
            >◈</span>
            <span 
              class="status-icon" 
              :class="{ available: project.report_id, unavailable: !project.report_id }"
              title="{{ $t('history.tooltipReport') }}"
            >◆</span>
          </div>
        </div>
        ...
        <div class="card-files-wrapper">
          ...
          <div class="files-list" v-if="project.files && project.files.length > 0">
            ...
            <div v-if="project.files.length > 3" class="files-more">
              +{{ project.files.length - 3 }} {{ $t('history.filesMoreCount') }}
            </div>
          </div>
          <!-- 无文件时的占位 -->
        ...
        <!-- 卡片标题（使用{{ $t('history.modalSimRequirement') }}的前20字作为标题） -->
        <h3 class="card-title">{{ getSimulationTitle(project.simulation_requirement) }}</h3>

        <!-- 卡片描述（{{ $t('history.modalSimRequirement') }}完整展示） -->
        ...
        <div v-if="selectedProject" class="modal-overlay" @click.self="closeModal">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <!-- 文件列表 -->
              <div class="modal-section">
                <div class="modal-label">{{ $t('history.modalLinkedFiles') }}</div>
                ...
                <div class="modal-empty" v-else>{{ $t('history.modalNoLinkedFiles') }}</div>
              </div>
            </div>

            <!-- {{ $t('history.modalPlaybackDivider') }}分割线 -->
            <div class="modal-divider">
              <span class="divider-line"></span>
              <span class="divider-text">{{ $t('history.modalPlaybackDivider') }}</span>
              <span class="divider-line"></span>
            </div>
            ...
            <div class="modal-actions">
              ...
              >
                ...
                <span class="btn-text">{{ $t('history.tooltipGraphBuild') }}</span>
              </button>
              <button 
              ...
              >
                ...
                <span class="btn-icon">◈</span>
                <span class="btn-text">{{ $t('history.tooltipEnvSetup') }}</span>
              </button>
              <button 
              ...
              >
                ...
                <span class="btn-icon">◆</span>
                <span class="btn-text">{{ $t('history.tooltipReport') }}</span>
              </button>
            </div>
            <!-- 不可回放提示 -->
